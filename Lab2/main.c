...
int main()
{
    const char *filepath = "H:\\MOS\\Lab2\\input.txt";
    ...
    int fdout = open ("H:\\MOS\\Lab2\\Receiver\\inter.txt", O_RDWR | O_CREAT | O_TRUNC, (mode_t)0600 );
    ...
    printf("time for mmap : %f seconds\n", (double)(clock() - start)/CLOCKS_PER_SEC);
    ...
    fptr = fopen("H:\\MOS\\Lab2\\input.txt", "r");
    fpout = fopen("H:\\MOS\\Lab2\\Receiver\\inter.txt", "w");
    ...
    printf("time for fopen : %f seconds\n", (double)(clock() - start)/CLOCKS_PER_SEC);
